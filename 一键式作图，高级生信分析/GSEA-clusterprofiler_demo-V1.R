...
####3、排序####
colnames(cluster)[4] = "gene"
FCgenelist = cluster$log2FC
...
####4.3、导出GO的GSEA结果####
write.csv(egseGO,file = "GOBP_GSEA.csv",row.names = F)
...
####5.3、导出KEGG的GSEA结果####
setwd("../")
write.csv(kegg2,file = "KEGG_GSEA.csv")
